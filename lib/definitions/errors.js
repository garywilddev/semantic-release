...
- A link to the **semantic-release** plugin developer guide: [${linkify('docs/developer-guide/plugin.md')}](${linkify(
  ...
  EINVALIDBRANCH: ({branch}) => ({message: '', details: ''}),
  EINVALIDBRANCHNAME: ({branch}) => ({message: '', details: ''}),
  EUNKNOWNBRANCH: ({unknowns}) => ({message: '', details: ''}),
  ELTSBRANCHES: ({branches}) => ({message: '', details: ''}),
  ERELEASEBRANCHES: ({branches}) => ({message: '', details: ''}),
  EPRERELEASEBRANCHES: ({branches}) => ({message: '', details: ''}),
  EDUPLICATEBRANCHES: ({duplicates}) => ({message: '', details: ''}),
};
